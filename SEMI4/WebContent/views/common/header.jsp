			...
			<div class="row align-items-center justify-content-between d-flex" >
				...
				<nav id="nav-menu-container" >
					<ul class="nav-menu">
						...
						<li><a href="/PETNER/hotelDbServlet?Market=HOTEL">HOTEL</a></li>
						<li><a href="/PETNER/hotelDbServlet?Market=HOSPITAL">HOSPITAL</a>
						</li>
						<li><a href="/PETNER/hotelDbServlet?Market=BEAUTY">BEAUTY</a></li>
						<li class="menu-has-children"><a>NOTICE</a>
							<ul>
								<li><a href="/PETNER/NoticeList.go">NOTICE</a></li>
								<li><a href="/PETNER/FAQlist.go">FAQ</a></li>
								<li><a href="/PETNER/QNAlist.go">Q&A</a></li>
							</ul>
						</li>
					</ul>
				</nav>
										...
										<div class="modal-body" style="text-align: center;">
								           ...
								           <!-- <div class="form-group">
											  ...
											  <div class="text-center">
												...
												<a href="/PETNER/views/member/searchPwForm.jsp" style="padding-right: 20px;">비밀번호 찾기</a>  
