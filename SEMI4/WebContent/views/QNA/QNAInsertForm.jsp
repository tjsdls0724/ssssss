...
<html>
	...
	<div style="padding-top:150px;">
				...
				<div class="row">
				  <div class="col-lg-7" style="margin: auto;">
					<div class="p-5">
					  ...
					  <form class="user" id="joinForm" action="<%= request.getContextPath() %>/QNAInsert.go" method="post">
						<div class="form-group row">
						</div>
						<div class="form-group">제목 :
						  <input type="text" class="form-control form-control-user" name="qtitle">
						</div>
						<div class="form-group row">
							<div class="col-sm-6 mb-3 mb-sm-0"> E-mail :
								<input type="text" value = "<%=m.getUserEmail()%>" class="form-control form-control-user" name="qemail" readonly>
							</div>
						</div>
		...
		<% } else {
		request.setAttribute("msg", "회원만 사용가능한 메뉴 입니다.");
