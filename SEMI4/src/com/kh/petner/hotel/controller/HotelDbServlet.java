...
public class HotelDbServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		session.setAttribute("temp", "ppppp");*/
		...
		int listCount = hs.getListCount(Market);
		...
		list = hs.selectList(currentPage, limit, Market, temp);
		...
		if(list != null) {
			...
			System.out.println("fight : " + temp);
			page = "views/hotel/hotel_home.jsp?Market="+Market+"&temp="+temp;
