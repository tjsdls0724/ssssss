...
public class HotelSearchServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("HotelSearchSerVlet Market : " + Market);
		...
		if(location != null) {
			...
			list = hs.searchHotelLocation(locationArr, Market);
...
//				HotelPageInfo hpi = new HotelPageInfo(currentPage,listCount,limit,maxPage,startPage,endPage);
			...
			// 페이징 처리
			int listCount = hs.getListCountHotelName(name,Market);
			...
			list = hs.searchHotelName(name,currentPage, limit, Market);
			
			String page = "";
			
			if(list != null) {
				System.out.println("HotelSearchSerVlet SearchName if문");
				page = "views/hotel/hotel_home.jsp?hon="+name+"&Market"+Market;
