...
public class MemberInsertServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("userPwdHintSelect : " + userPwdHintSelect);
		System.out.println("userPwdHint : " + userPwdHint);
		...
		//회원 가입시 전달을위한 vo생성
		Member m = new Member(userEmail, userPwd, userName, userPhone,userPwdHintSelect,userPwdHint);
